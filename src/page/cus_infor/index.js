        ...
        <>
            <div className='cus_main'>
                <table className="cusinfo">
                    <tr>
                        <td><Link to="/doithuong" className="black-link">Đổi thưởng</Link></td>
                    </tr>
                    <tr>
                        <td><Link to="/histour" className="black-link">Tour đã đi</Link></td>
                    </tr>
                    <tr>
                        <td><Link to="/repass" className="black-link">Đổi mật khẩu</Link></td>
                    </tr>
                    <tr>
                        <td><a href="/logout" style={{ color: "red", borderTop: "1px solid #e0e0e0" }}>Đăng xuất</a></td>
                    </tr>
                </table>
